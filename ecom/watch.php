...
<body>
    <div class="containerr">
        <div class="header">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li>
                        <div class="dropdown">
                            <button class="dropbtn"><a href="#">Category <i
                                        class="fa-solid fa-caret-down"></i></a></button>
                    ...
                    <li>
                        <div class="dropdown">
                            <button class="dropbtn"><a href="#">Shops <i
                                        class="fa-solid fa-caret-down"></i></a></button>
                            <div class="dropdown-content">
        ...
        <div class="backimg" style="background-image: url(watches/back.jpg);">
          <div class="massage">
            <h2>OUR STORE</h2>
...
<div class="products">
    ...
    <?php
       ...
       $qp = "select * from Products where PID between 7 and 12";
